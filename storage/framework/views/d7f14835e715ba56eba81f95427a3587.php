...
<body>
    ...
    <?php endif; ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="<?php echo e(route('client.store')); ?>" class="needs-check" novalidate>
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <label>Nom</label>
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    ...
                                    data-bs-target="#deleteModal<?php echo e($clients->idcli); ?>">Supprimer</button>
                                </div>
                            </td>
                        </tr>
                        <div class="modal fade" id="editModal<?php echo e($clients->idcli); ?>" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="<?php echo e(route('client.update',$clients->idcli)); ?>" class="needs-check" novalidate>
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                pattern="[A-Za-zÀ-ÖØ-öø-ÿ '\-]+" title="Le nom ne doit contenir que des lettres"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                maxlength="10" pattern="03[0-9]{8}" title="Le numéro doit commencer par 03 et contenir 10 chiffres"
                        ...
                        <div class="modal fade" id="deleteModal<?php echo e($clients->idcli); ?>" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        Voulez-vous vraiment supprimer le client <b><?php echo e($clients->nom); ?></b> ?
                                        Ses réservations seront supprimées et les places associées libérées.
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                                        <form method="post" action="<?php echo e(route('client.destroy', $clients->idcli)); ?>">
                                            <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        document.querySelectorAll('form.needs-check').forEach(function (form) {
            ...
            champNom.addEventListener('input', function () {
                validerChamp(champNom, regexNom, msgNom, 'Le nom ne doit contenir que des lettres.');
            });
            champTel.addEventListener('input', function () {
                champTel.value = champTel.value.replace(/[^0-9]/g, '').slice(0, 10);
                validerChamp(champTel, regexTel, msgTel, 'Le numéro doit commencer par 03 et contenir 10 chiffres.');
            });

            form.addEventListener('submit', function (e) {
                const nomOk = validerChamp(champNom, regexNom, msgNom, 'Le nom ne doit contenir que des lettres.');
                const telOk = validerChamp(champTel, regexTel, msgTel, 'Le numéro doit commencer par 03 et contenir 10 chiffres.');
                if (!nomOk || !telOk) {
                    e.preventDefault();
                }
            });
...
<?php /**PATH C:\TANJONA\projet_php\resources\views/client.blade.php ENDPATH**/ ?>